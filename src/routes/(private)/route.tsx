...
export const Route = createFileRoute("/(private)")({
	head: () =>
		buildPageHead({
			...
			description: "Area administrativa da Autoria.",
...
function PrivateLayout() {
	...
	return (
		<main className="min-h-screen flex flex-col bg-background">
			<header className="bg-header text-header-foreground py-4 sm:py-0 px-4 sm:px-28 w-full z-20 flex items-center justify-between">
				<Link
