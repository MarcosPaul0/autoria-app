...
import { ProductCategoryStatusBadge } from "./product-category-status-badge";
...
export function ProductCategoryItem({ productCategory }: CategoryItemProps) {
	return (
		<TableRow>
			...
			<TableCell>
				<ProductCategoryStatusBadge isActive={productCategory.isActive} />
			</TableCell>
