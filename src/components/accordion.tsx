...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn('not-last:border-b border-primary/10', className)}
      {...props}
    />
  )
}
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-open:animate-accordion-down data-closed:animate-accordion-up text-sm sm:text-base overflow-hidden"
      {...props}
    >
      <div
        className={cn(
